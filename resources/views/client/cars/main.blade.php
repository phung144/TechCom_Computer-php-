        ...
        @if ($carts->count() == 0)
            <div class="container py-5">
                <div class="text-center my-5">
                    <h2 class="mb-3 text-danger"><i class="fas fa-shopping-cart"></i> Giỏ hàng của bạn đang trống!</h2>
                    <p class="lead mb-4">Hãy thêm sản phẩm vào giỏ hàng để tiếp tục mua sắm.</p>
                    <a href="{{ route('shop-home') }}" class="btn btn-primary btn-lg">
                        <i class="fas fa-arrow-right me-2"></i> Tới cửa hàng
                    </a>
                </div>
            </div>
        @else
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="{{ route('client-home') }}"
                                            class="text-decoration-none text-primary"><i class="fas fa-home me-1"></i> Trang
                                            chủ</a>
                                    </li>
                                ...
                                <tbody>
                                    @foreach ($carts as $cart)
                                        @php
                                            ...
                                            $hasDiscount =
                                                $cart->product->discount_type && $cart->product->discount_value > 0;
                                            ...
                                            if ($hasDiscount) {
                                                if (
                                                    ...
                                                    $discountedPrice =
                                                        $basePrice * (1 - $cart->product->discount_value / 100);
                                                } else {
                                        ...
                                        <tr data-cart-id="{{ $cart->id }}" class="align-middle">
                                            <td class="text-center">
                                                <form class="delete-cart-form"
                                                    ...
                                                    @csrf
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger rounded-circle delete-cart-btn">
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <div class="input-group quantity-control" style="max-width: 120px;">
                                                        <input type="text"
                                                            class="form-control text-center js-quantity-input"
                                                            value="{{ $cart->quantity }}"
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h3 class="h4 mb-0 text-gradient-primary">
                                <i class="fas fa-tag me-2"></i>Phiếu giảm giá ưu đãi
                            </h3>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <small class="text-muted">
                                                            ...
                                                            @if (!empty($voucher->max_discount) && $voucher->max_discount > 0)
                                                                <br>
                                                                Max discount: {{ number_format($voucher->max_discount) }}
                                                                VND
                                                            @endif
                                                        </small>
                                                    </div>
                                                ...
                                                <div class="text-end">
                                                    ...
                                                    @if ($voucher->min_order_value > $subtotal)
                                                        <div class="mt-2 text-danger small">
                                                            ...
                                                            {{ number_format($voucher->min_order_value - $subtotal) }} VND
                                                            more
                                                        </div>
                                                    @endif
                                                </div>
                        ...
                        <div class="card shadow-sm mb-4 border-0">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h3 class="h4 mb-0 text-gradient-primary">
                                        <i class="fas fa-address-card me-2"></i>Thông tin, địa chỉ khách hàng
                                    </h3>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="full_name" name="full_name"
                                                    class="form-control" placeholder="Jack Wayley" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="address" name="address" class="form-control"
                                                    placeholder="470 Lucy Forks, London" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                        ...
                        <div class="card shadow-sm border-0 sticky-top" style="top: 20px;">
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush mb-4">
                                    ...
                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center fw-bold fs-5">
                                        <span>Tổng cộng</span>
                                ...
                                <form action="{{ route('momo.payment') }}" method="post" id="momo-form">
                                    ...
                                    <input type="hidden" name="total_after_discount" id="momo_total_after_discount"
                                        value="{{ $subtotal }}">
                                ...
                                <script>
                                    ...
                                    document.getElementById('momo-form').addEventListener('submit', function(e) {
                                        ...
                                        document.getElementById('momo_total_after_discount').value = document.getElementById(
                                            'order-total-after-discount').value;
                                    });
                                </script>
                                {{--
    ...
    <script>
        ...
        function applyVoucher(element) {
            ...
            if (minOrder > subtotal) {
                alert(`Mã giảm giá chỉ áp dụng cho đơn hàng có giá trị trên ${minOrder.toLocaleString()} VND`);
                return;
            }
            ...
            try {
                ...
                if (data.changed && data.changed.length > 0) {
                    ...
                    data.changed.forEach(item => {
                        if (item.type === 'price') {
                            html +=
                                `<li><b>${item.name}</b>: Giá cũ <span style="color:#888">${item.old_price.toLocaleString()} VND</span> &rarr; Giá mới <span style="color:#e74c3c">${item.new_price.toLocaleString()} VND</span></li>`;
                        } else if (item.type === 'quantity') {
                            html +=
                                `<li><b>${item.name}${item.variant ? ' (' + item.variant + ')' : ''}</b>: Chỉ còn <span style="color:#e74c3c">${item.available}</span> sản phẩm, bạn đã chọn <span style="color:#888">${item.requested}</span></li>`;
                        }
                    });
                    html += '</ul>';
                    Swal.fire({
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (orderForm) {
                orderForm.addEventListener('submit', function(e) {
                    // Validate các trường thông tin khách hàng trước khi kiểm tra giá
                    ...
                    if (!fullName || !email || !address || !phone) {
                        showErrorAlert('Vui lòng nhập đầy đủ thông tin khách hàng trước khi đặt hàng.');
                        e.preventDefault();
                        return false;
                    }
                    ...
                    // Validate số điện thoại (chỉ số, tối thiểu 8 ký tự)
                    ...
                    // Nếu hợp lệ, tiếp tục kiểm tra giá trước khi submit
            ...
            if (momoForm) {
                momoForm.addEventListener('submit', function(e) {
                    ...
                    if (!fullName || !email || !address || !phone) {
                        showErrorAlert('Vui lòng nhập đầy đủ thông tin khách hàng trước khi thanh toán MOMO.');
                        e.preventDefault();
                        return false;
                    }
                    // Validate email format đơn giản
